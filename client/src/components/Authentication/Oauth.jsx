...
const Oauth = () => {
  ...
  return (
    <>
        ...
        {/* Email */}
<button onClick={handleClick} className="btn bg-white hidden text-black border-[#e5e5e5]">
...
{/* Google */}
<button onClick={() => window.location.href = GOOGLE_LOGIN_URL} className="btn bg-white text-black border-[#e5e5e5]">
